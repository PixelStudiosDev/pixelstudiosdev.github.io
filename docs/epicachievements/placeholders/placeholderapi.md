...
| `%achievements_achievement_<id>_`<br/>`<points/requirement/progress/percentage/bar/unlocked/date>_[tier]%` | Information about a specific achievement.<br/>Tier defaults to `1` when unspecified. |

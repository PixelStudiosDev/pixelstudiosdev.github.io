...
<Tabs>
    <TabItem value="new" label="v2.0" default>
        ...
        | | | | | |
        | `NONE`        | Not linked to any in-game action. Can only be progressed using [admin commands](../commands-and-permissions#admin-commands). |                                                                    | 1.8                       |
        ...
        | | `ECONOMY_SHOP_GUI:SELL` | Sell an item | `items` |
    </TabItem>
